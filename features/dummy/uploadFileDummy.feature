Feature: Upload a Dummy File

  @http
  Scenario: Upload a Dummy File resource
    Given a file named "uploadDummyFile.pdf" with:
    """
    Upload Dummy File
    """
    When one upload a dummy file "uploadDummyFile.pdf"
    Then created
